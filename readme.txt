...
словарь, ключами которого являются "snum", "surname", "received_in", "name", "patronym", "gender", "birth", "born_in", "receive_date", "code" - серия и номер, фамилия, место выдачи, имя, отчество, пол, дата рождения, место рождения, дата выдачи и код подразделения соответственно.
Значениями, кодируемыми ключами, являются списки следующего формата:
[[a1,b1],[a2,b2],[a3,b3],[a4,b4]], где a1/b1 * ширину паспорта - левая граница поля на изображении, a2/b2 * высоту - верхняя, a3/b3 * .. - правая, a4/b4 * .. - нижняя
